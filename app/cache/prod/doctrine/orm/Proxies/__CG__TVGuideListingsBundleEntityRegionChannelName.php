 ...
 */
class RegionChannelName extends \TVGuide\ListingsBundle\Entity\RegionChannelName implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'TVGuide\\ListingsBundle\\Entity\\RegionChannelName' . "\0" . 'id', '' . "\0" . 'TVGuide\\ListingsBundle\\Entity\\RegionChannelName' . "\0" . 'regionId', '' . "\0" . 'TVGuide\\ListingsBundle\\Entity\\RegionChannelName' . "\0" . 'channelId', '' . "\0" . 'TVGuide\\ListingsBundle\\Entity\\RegionChannelName' . "\0" . 'channelName', 'channels');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegionChannelName $proxy) {
